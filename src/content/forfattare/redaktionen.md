...
Det redaktionen står för är sättet att arbeta. Varje siffra har en källa vid sig, och tillverkarens kapacitet återges tillsammans med villkoret den är mätt vid. En maskin vi inte haft i handen kallas granskad, inte testad. Hur det går till, och vad som kommer att mätas, står på [så testar vi](/om/sa-testar-vi/).
