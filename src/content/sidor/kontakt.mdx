---
title: Kontakt
description: Så når du redaktionen på Hantverkstips via mejl, hur snabbt du kan vänta dig svar, och vad vi helst vill höra om, alltså fel, priser och egna mätningar.
uppdaterad: 2026-09-16
utkast: false
---

Skriv till [info@hantverkstips.se](mailto:info@hantverkstips.se). Vi svarar inom en vecka, oftast fortare.
