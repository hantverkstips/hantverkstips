...
- **Externa länkar i brödtext** (beslut 2026-09-24, första gången på elsidorna): bara när läsaren ska *göra* något på den andra sidan, som att läsa myndighetens lista eller söka i ett register. Källhänvisning i övrigt görs i löptext och i `kallor`, inte som länk. Tillåtna mål är myndigheter, lagtext och offentliga register (Elsäkerhetsverket, Boverket, Skatteverket, riksdagen.se). Aldrig en firma, en butik, ett forum eller en konkurrent i brödtext; de står bara i `kallor`. Skrivs som vanlig Markdown-länk utan `rel` och utan `target`: länken är ett redaktionellt val till en myndighet och får följas, och den öppnas i samma flik som alla andra länkar på sajten. Ankaret säger vad läsaren hittar där, gärna myndighetens eget namn på sidan. Högst en extern länk per H2, och samma adress ska också stå i `kallor`. Källistan i mallen behåller `rel="nofollow"`, eftersom den blandar myndigheter med firmor och forum. Affiliatelänkar är en egen sak och går alltid via `/go/` med `rel="sponsored nofollow"`. Inget i mallen behöver ändras för det här.
