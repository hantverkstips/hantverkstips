...
Mönstret för nästa verktyg (formel, test, formulärkomponent, sida, register, inbäddning) står i `docs/SPEC-SIDMALLAR.md` avsnitt 4.7, elkostnadens produkt-parameter i 4.7.3, innerväggsräknarens produktkort i 4.7.4 och beslutsverktygets regler med lagrum i 4.7.5.

## Vad som byggs först

Verktyg 1, 2, 3 och 5 är byggda. Verktyg 4 är det som återstår av de mest unika, och det väntar på att gipsväggens pluggsidor får sina tal. 6 och 7 är trafikmagneter som bygger länkar och ger sajten en anledning att synas i forum. 8 till 14 följer när ämnena får sidor.
