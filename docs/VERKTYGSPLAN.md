...
Mönstret för nästa verktyg (formel, test, formulärkomponent, sida, register, inbäddning) står i `docs/SPEC-SIDMALLAR.md` avsnitt 4.7, och elkostnadens produkt-parameter i 4.7.3.

## Vad som byggs först

Verktyg 1 och 2 är byggda. Verktyg 3 är en ren beräkning på en källa vi redan har (Svenskt Trä) och kan byggas utan mätningar. Verktyg 4 och 5 är de mest unika och binder ihop två kluster som redan finns; 5 kan byggas nu på bygglovssidans lagrum. 6 och 7 är trafikmagneter som bygger länkar och ger sajten en anledning att synas i forum. 8 till 14 följer när ämnena får sidor.
