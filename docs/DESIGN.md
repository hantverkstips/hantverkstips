...
**Sidhuvudet byter stil, beslutat 2026-09-19.** Christian vill att räknarnas bild ovanför vecket håller samma stil som symbolen och startsidans hero. Därför får varje verktyg en andra bild, en varumärkesillustration i `src/assets/illustrationer/rakna/varumarke/[slug].svg`, 600 × 360 så att den passar samma 7/5-rutnät och samma gallerikort som skissen. Den följer reglerna under Varumärkesillustrationen ovan utan undantag: tumstocken som form, ingen text och inga läsbara tal, ett pennstreck, transparent bakgrund, inga pyttedetaljer, motivet fyller ytan. Den har ingen källa under `illustrationer-kallor/` eftersom den saknar `<text>`. Sidhuvudet och kortet i galleriet visar varumärkesbilden när den finns, annars skissen som förut, så de tio verktyg som ännu saknar en fortsätter fungera. Skissen försvinner inte: den flyttar ner till avsnittet "Så räknar vi", där den förklarar räkningen med sina mått, och den är fortfarande delningsbilden, eftersom nyckeltalet är kroken när någon delar länken. Dränering är prototypen; de andra tio ritas när Christian sett den och sagt ja.
