...
Sökfraserna "fuktig källare vad göra" (H1, ingressen och första frågan), "fukt i källaren åtgärd" (H2 om de tre vattnen och första frågan), "markfukt eller kondens" (andra frågan och tejptestets rader) och "besiktiga källaren själv" (tredje frågan och titeln) ligger i rubrikerna och i första stycket. `<title>` "Fuktig källare, vad ska du göra? Besiktiga själv", 47 tecken; med suffixet blir den 63 och layouten utelämnar det därför. Slugen finns i `MED_FORMULAR`, och `<Kalkylator namn="kallare" />` är inbäddad i `/fukt/fukt-i-kallaren/` direkt efter symptomtabellens förklarande stycke, alltså där läsaren just fått veta vad hon ska titta efter.
